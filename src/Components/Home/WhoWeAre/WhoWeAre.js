        ...
        <div className='container'>
            ...
            <div className='col-lg-4 col-sm-12'>
                    <div className={`${styles["who-we-are__info"]} `}>
                            ...
                            . مجموعة هذه حياتي التطوعية ، مجموعة شبابية تعنى برفع سوية المجتمع والعمل التطوعي 
                            </p>
                            <p className={`${styles["who-we-are__info_p"]} mb-5`}>  
                            .أسست عام 2010 في الأردن ومرخصة سنة 2016 كـ شركة غير ربحية ، وكجمعية خيرية في سويسرا 2020 ، وتوسعت أنشطة عملها ل تركيا و الداخل السوري 
                            </p>
                            <Link to="" className={`${styles["who-we-are__info_btn"]} ` } >التبرع الفوري</Link>
                        </div>
                </div>
                        ...
                        <div className='col-lg-4 col-sm-12 mb-5'>
                            <div className={`${styles["who-we-are__img-container"]}`}>
                                ...
                                <div className={`${styles['who-we-are__img-info']}`}>
                                     <h4 className={`${styles['who-we-are__img-info-h2']}`}>ابتسم</h4>
                                </div>
                            </div>
                            </div>
                            <div className='col-lg-4 col-sm-12 '>
                                <div className={`${styles["who-we-are__img-container_modify"]}`}>
                                    ...
                                    <div className={`${styles['who-we-are__img-info_modify']}`}>
                                        <h4 className={`${styles['who-we-are__img-info-h2-modify']} `}>شارك</h4>
                                    </div>
                            ...
                            <div className='col-lg-4 col-sm-12'>
                                <div className={`${styles["who-we-are__img-container"]}`}>
                                    ...
                                    <div className={`${styles['who-we-are__img-info']}`}>
                                        <h4 className={`${styles['who-we-are__img-info-h2']}`}>ساعد</h4>
                                    </div>
